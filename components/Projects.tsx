  ...
  return (
    ...
    >
      ...
      >
        {isWidthSmall ? null : (
          <motion.div
            className='h-auto w-1/3 sm:p-4 lg:p-8 flex flex-col object-contain gap-8 bg-primary-light bg-opacity-40 dark:bg-opacity-5 border-2 border-opacity-10 rounded-xl shadow-xl border-primary-light hover:bg-opacity-30 dark:hover:bg-opacity-10'
            whileHover={{
              scale: 1.025,
